...
const FEATURES = [
  { icon: Brain,    title: 'Lokales Training',      desc: 'Trainiere KI-Modelle direkt auf deinem Rechner — DSGVO-konform, keine Cloud.', color: '#a78bfa', bg: 'rgba(167,139,250,0.08)', border: 'rgba(167,139,250,0.2)' },
  { icon: Zap,      title: 'LoRA Fine-Tuning',       desc: 'Effizientes Fine-Tuning großer Modelle mit wenig VRAM durch LoRA-Adapter.',   color: '#f472b6', bg: 'rgba(244,114,182,0.08)', border: 'rgba(244,114,182,0.2)' },
  { icon: BarChart3,title: 'Live Monitoring',        desc: 'Echtzeit-Übersicht über Loss, GPU-Auslastung und Trainingsfortschritt.',       color: '#22d3ee', bg: 'rgba(34,211,238,0.08)',  border: 'rgba(34,211,238,0.2)'  },
  { icon: Layers,   title: 'FrameSphere Connected',  desc: 'Dein FrameSphere-Konto ist verknüpft — ein Login für alle deine Tools.',       color: '#34d399', bg: 'rgba(52,211,153,0.08)',  border: 'rgba(52,211,153,0.2)'  },
]
      ...
      <main style={{ position: 'relative', zIndex: 1, minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 16px', fontFamily: "'DM Sans', sans-serif" }}>
        <div style={{ width: '100%', maxWidth: 600, display: 'flex', flexDirection: 'column', gap: 48 }}>
          ...
          <div style={{
            ...
            {!hasPaid && (
              <p style={{ color: '#374151', fontSize: 13 }}>Einmaliger Kauf · danach unlimitierter Zugang</p>
            )}
          </div>
