        ...
        <div className="w-full max-w-lg">
          ...
          <div className="rounded-3xl p-8 md:p-10 text-center"
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              {t('subtitleLine1')}
              <br />
              <span className="text-gray-500 text-base">{t('subtitleLine2')}</span>
            </p>

            {/* Info Box */}
            <div className="rounded-2xl p-5 mb-8 text-left"
              style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <h2 className="text-white font-semibold mb-3 text-sm uppercase tracking-widest opacity-60">{t('infoHeading')}</h2>
